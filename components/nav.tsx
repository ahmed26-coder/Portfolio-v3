...
interface MenuItemProps {
  icon: LucideIcon; // Use LucideIcon type from lucide-react for icon prop
  label: string;
  isExpanded: boolean;
  isActive: boolean;
  onClick: () => void;
...
const MenuItem = React.memo(function MenuItem({ icon: Icon, label, isExpanded, isActive, onClick }: MenuItemProps) {
    return (
        <div
            className={`flex items-center p-3 text-lg rounded-lg cursor-pointer transition-all duration-200 ${isActive
...
const SocialIcon = React.memo(function SocialIcon({ height, width, icon, href = "#", title = "" }: SocialIconProps) {
                    ...
                    <>
                        ...
                        >
                            <div className="flex flex-col items-center mb-4">
                                ...
                                />
                                <div className="text-center mt-2">
                                    <h2 className="text-xl text-[#111111] dark:text-white font-semibold">
                                        Ahmad Adham
                                    </h2>
                                    <p className="text-sm text-[#666666]">Front-end Developer</p>
                            ...
                            <div
                                onClick={toggleTheme}
                                className="flex justify-center dark:text-[#FFFFFF]/40 my-6"
                            >
                                <SocialIcon icon={Sun} title="Toggle Theme" />
                            </div>
                        </motion.div>
